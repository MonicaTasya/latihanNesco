...
const Hero = () => {
  ...
  <span></span>
        ...
        <div className="absolute top-[1081px] lg:top-[550px] lg:right-0 lg:w-[360px] w-full px-4 lg:px-0">
          <img className="hidden lg:block lg:w-[300px] lg:right-[-120px] lg:h-auto lg:absolute lg:top-[-100px]" src="/images/redBoom.webp" alt="merah"></img>
          <img className="hidden lg:block lg:w-[80px] lg:right-[-20px] lg:h-auto lg:absolute lg:top-[-36px]" src="/images/bola.webp" alt="bola"></img>
